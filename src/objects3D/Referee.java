...
public class Referee {
    ...
    public void DrawReferee(int stage, int judge, int ballStep, Texture texture_jeans, Texture texture_clothes) {
...
//        }
        ...
        if (judge >= 27) {
            ...
            if (step - 75 < 10) {
                LimbRotation = (step - 75 + 1) * 10;
            } else if (step - 75 >= 10) {
                LimbRotation = 90 - (step - 75 - 4) * 20 / 3;
            }
        }
...
//                                GL11.glRotatef((-Math.abs(LimbRotation / 2 - 30)), 1.0f, 0.0f, 0.0f);
                ...
                GL11.glPushMatrix();
                {
                    ...
                    GL11.glScalef(0.75f, 0.2f, 0.75f);
                    cube.DrawCube();
...
//                    GL11.glPushMatrix();
//                    {
//                        GL11.glTranslatef(0.0f, 0.65f, 0.95f);
//                        GL11.glScalef(0.75f, 0.75f, 0.2f);
//                        cube.DrawCube(10);
//                    }
//                    GL11.glPopMatrix();
                    ...
                    GL11.glPushMatrix();
                    {
                        GL11.glTranslatef(-0.65f, -11f, 0.65f);
                        GL11.glScalef(0.15f, 11.2f, 0.15f);
                        cube.DrawCube();
                    }
                    GL11.glPopMatrix();
