...
public class SmashPlayer {
    ...
    public void DrawSmashPlayer(String name, int ballStep, Texture texture_jeans, Texture texture_clothes) {
...
//        }
        ...
        if (name == "player1") {
            if (ballStep >= 45 && ballStep < 50) {
                LimbRotation = (ballStep - 44) * -6;
            } else if (ballStep >= 50 && ballStep < 55) {
                LimbRotation = (ballStep - 49) * 12;
            } else if (ballStep >= 55 && ballStep < 60) {
                LimbRotation = 30 + (ballStep - 56) * -6;
            }
        } else if (name == "player3") {
            if (ballStep >= 145 && ballStep < 150) {
                LimbRotation = (ballStep - 144) * -6;
            } else if (ballStep >= 150 && ballStep < 155) {
                LimbRotation = (ballStep - 149) * 12;
            } else if (ballStep >= 155 && ballStep < 160) {
                LimbRotation = 30 + (ballStep - 154) * -6;
            }
        }
