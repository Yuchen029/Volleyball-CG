...
public class CatchPlayer {
    ...
    public void DrawCatchPlayer(String name, int judge, int ballStep, Texture texture_jeans, Texture texture_clothes) {
//        float theta = (float) (delta * 2 * Math.PI) * 6;
//        // control rotate
//        float LimbRotation;
//        if (GoodAnimation) {
...
//        }
        ...
        if (judge != 1) {
            if (name == "player2") {
                if (ballStep >= 195) {
                    LimbRotation = (ballStep - 194) * -6;
                } else if (ballStep < 5) {
                    LimbRotation = (ballStep + 1) * 12;
                } else if (ballStep >= 5 && ballStep < 10) {
                    LimbRotation = 30 + (ballStep - 4) * -6;
                }
            } else if (name == "player4") {
                if (ballStep >= 95 && ballStep < 100) {
                    LimbRotation = (ballStep - 94) * -6;
                } else if (ballStep >= 100 && ballStep < 105) {
                    LimbRotation = (ballStep - 99) * 12;
                } else if (ballStep >= 105 && ballStep < 110) {
                    LimbRotation = 30 + (ballStep - 104) * -6;
                }
            }
        }
...

        {
            ...
            GL11.glPushMatrix(); {
                ...
                GL11.glPushMatrix(); {
                    GL11.glTranslatef(0.0f,0.15f,1.0f);
                ...
                GL11.glPushMatrix(); {
                    ...
                    GL11.glPushMatrix(); {
                        ...
                        GL11.glRotatef(LimbRotation / 2, 0, 1, 0);
                        GL11.glRotatef(LimbRotation / 2, 1, 0, 0);
...
//                        GL11.glRotatef(LimbRotation,1.0f,0.0f,0.0f);
                        ...
                        GL11.glPushMatrix(); {
                            ...
                            GL11.glPushMatrix(); {
                                ...
                                GL11.glRotatef(90.0f,1.0f,0.0f,0.0f);
                                GL11.glRotatef(-90.0f,0.0f,1.0f,0.0f);
                                GL11.glRotatef(LimbRotation, 0, 1, 0);
                                //   GL11.glRotatef(90.0f,0.0f,1.0f,0.0f);
